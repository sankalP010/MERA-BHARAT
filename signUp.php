...
<body>
  ...
  <!-- background images -->
  <img src="at-infinity--Nb_KvPkxn0-unsplash.jpg" id="backgroundVideo">
  <img src="at-infinity--Nb_KvPkxn0-unsplash.jpg" alt="Mobile-Imange" id="backgroundImage">
  ...
  if (isset($_POST['signup'])) {
    ...
    if ($emailres->num_rows > 0) {
      ...
      if ($password === $cpassword) {
        $sql = "INSERT INTO `users` (`name`, `email`, `username`, `password`, `status`, `profile_img`, `location`) VALUES ('$name', '$email', '$username', '$password', NULL, NULL, NULL)";
        ...
        if ($result->num_rows > 0) {
          while($row = $result->fetch_assoc()) {
            $id = $row['user_id'];
            $sql = "INSERT INTO `notifications` (`user_id`, `notification`) VALUES ('$id' ,'WELCOME TO MERA BHARAT')";
            $res = $conn->query($sql);
          }
        }
  ...
  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" id="signup-form">
    <div class="login-box">
      ...
      <iframe id="t-and-c" src="php/terms-and-conditions.php" height="100" width="100%" title="Terms and Conditions"></iframe>
